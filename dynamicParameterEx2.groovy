        ...
        [
            ...
            script: [
                ...
                script: [
                    ...
                    def proc = 'aws ec2 describe-instances --profile=dunkindev --region us-east-1 --filter Name=name,Values=swi --query Reservations[*].Instances[*].PrivateIpAddress --output text'.execute()
